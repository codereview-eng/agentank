...
export const LOCALES = {
  zh: {
    ...
    ui: {
      ...
      rvAdoptNoChange: '战术已写入战术框，但代码没有变化 —— 跳过一个必然无差异的对比',
      rvBusy: '批量正在跑，先等它跑完',
      rvNoFlag: '本局没标出可疑操作',
      rvTitleSingle: '复盘这一局',
      rvTitleBatch: '战术复盘',
...
export default function decide(api) {
  ...
  en: {
    ...
    ui: {
      ...
      rvAdoptNoChange: 'Tactics written to the box, but the code did not change — skipping a comparison that is guaranteed to show no difference',
