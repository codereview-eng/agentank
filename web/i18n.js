...
export const LOCALES = {
  zh: {
    ...
    ui: {
      ...
      strategyPh: '用一句话描述你的战术，如：贴脸抢星，血量低于30%就传送到最安全的角落',
      genBtn: '⚡ AI 生成脚本',
      codeBox: '查看/编辑脚本（高级）',
      myTank: '我的坦克',
      opponent: '对手',
    ...
    play: {
      ...
      genFail: '生成失败：{msg}',
      genNeedLogin: '需要登录后才能使用 AI 生成（点右上角「登录」）',
...
export default function decide(api) {
  ...
  en: {
    ...
    ui: {
      ...
      strategyPh: 'Describe your tactics in one line, e.g. rush stars, teleport to the safest corner below 30% HP',
      genBtn: '⚡ Generate script with AI',
    ...
    play: {
      ...
      bridgeCloseBtn: 'OK',
      genLoginBtn: '🔑 Sign in to use AI generation',
      ...
      genNeedLogin: 'Sign in to use AI generation (top-right "Sign in")',
